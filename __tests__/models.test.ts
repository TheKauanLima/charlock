...
describe('Mongoose model schemas', () => {
  ...
  it('stores named panel variants for every stat category', () => {
    ...
    expect(BoonStats.schema.path('name')).toBeDefined()
  ...
  it('stores publishing state and community likes on custom heroes', () => {
    ...
    expect(CustomHero.schema.path('renderPosition.x')).toBeDefined()
    expect(CustomHero.schema.path('renderPosition.y')).toBeDefined()
